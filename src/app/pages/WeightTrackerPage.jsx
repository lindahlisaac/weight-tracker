...
/**
 * 
 * WeightTrackerPage holds all components contained in the weight tracker page. Duh.
 * Wegihtlist, filter, stats, add weight button bar
 * 
 */
...
export default function WeightTrackerPage() {
    ...
    return (
        <>
            <Header headerValue='Weight Tracker'/>
